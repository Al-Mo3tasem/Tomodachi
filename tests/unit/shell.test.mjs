...
const shell = await import('../../js/native/shell.js?v=20260906g');
const prefs = await import('../../js/core/prefs.js?v=20260906g');   // same instance shell.js installs the adapter into
