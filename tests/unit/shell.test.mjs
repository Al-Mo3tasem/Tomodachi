...
const shell = await import('../../js/native/shell.js?v=20260911b');
const prefs = await import('../../js/core/prefs.js?v=20260911b');   // same instance shell.js installs the adapter into
