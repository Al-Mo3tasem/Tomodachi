...
const shell = await import('../../js/native/shell.js?v=20260911c');
const prefs = await import('../../js/core/prefs.js?v=20260911c');   // same instance shell.js installs the adapter into
