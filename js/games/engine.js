...
import { fmtNumber, fmtTime } from '../core/format.js?v=20260911c';
import { haptic } from '../core/haptics.js?v=20260911c';
import { confirmDestructive, openSheet, closeSheet } from '../ui/sheet.js?v=20260911c';
import { mountHud, updateHud } from '../ui/hud.js?v=20260911c';
import { showResultsSheet, hideResultsSheet } from '../ui/results.js?v=20260911c';
import { statusChip } from '../ui/status.js?v=20260911c';
import { renderChoiceTiles } from '../ui/quiz-tiles.js?v=20260911c';
...
} from '../audio/audio.js?v=20260911c';
import { submitSurvivalScore, bracketFor } from '../data/leaderboards.js?v=20260911c';
