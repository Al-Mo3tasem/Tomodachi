...
import { I18N_CONFIG } from '../config/i18n.js?v=20260911b';
import { applyTranslations } from './apply.js?v=20260911b';
import { applyDirection } from './rtl.js?v=20260911b';
import { getPref, setPref } from '../core/prefs.js?v=20260911b';
import { fmtNumber, localizeDigits } from '../core/format.js?v=20260911b';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260911b`, import.meta.url);
