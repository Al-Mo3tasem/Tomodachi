...
import { I18N_CONFIG } from '../config/i18n.js?v=20260807a';
import { applyTranslations } from './apply.js?v=20260807a';
import { applyDirection } from './rtl.js?v=20260807a';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260807a`, import.meta.url);
