...
import { I18N_CONFIG } from '../config/i18n.js?v=20260911c';
import { applyTranslations } from './apply.js?v=20260911c';
import { applyDirection } from './rtl.js?v=20260911c';
import { getPref, setPref } from '../core/prefs.js?v=20260911c';
import { fmtNumber, localizeDigits } from '../core/format.js?v=20260911c';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260911c`, import.meta.url);
