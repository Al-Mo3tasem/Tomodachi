...
import { I18N_CONFIG } from '../config/i18n.js?v=20260726c';
import { applyTranslations } from './apply.js?v=20260726c';
import { applyDirection } from './rtl.js?v=20260726c';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260726c`, import.meta.url);
