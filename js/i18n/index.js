...
import { I18N_CONFIG } from '../config/i18n.js?v=20260801b';
import { applyTranslations } from './apply.js?v=20260801b';
import { applyDirection } from './rtl.js?v=20260801b';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260801b`, import.meta.url);
