...
import { I18N_CONFIG } from '../config/i18n.js?v=20260911a';
import { applyTranslations } from './apply.js?v=20260911a';
import { applyDirection } from './rtl.js?v=20260911a';
import { getPref, setPref } from '../core/prefs.js?v=20260911a';
import { fmtNumber, localizeDigits } from '../core/format.js?v=20260911a';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260911a`, import.meta.url);
