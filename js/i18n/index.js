...
import { I18N_CONFIG } from '../config/i18n.js?v=20260802b';
import { applyTranslations } from './apply.js?v=20260802b';
import { applyDirection } from './rtl.js?v=20260802b';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260802b`, import.meta.url);
