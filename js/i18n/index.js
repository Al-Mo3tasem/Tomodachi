...
import { I18N_CONFIG } from '../config/i18n.js?v=20260723a';
import { applyTranslations } from './apply.js?v=20260723a';
import { applyDirection } from './rtl.js?v=20260723a';
...
async function loadLocale(lang) {
  const url = new URL(`./locales/${lang}.json?v=20260723a`, import.meta.url);
