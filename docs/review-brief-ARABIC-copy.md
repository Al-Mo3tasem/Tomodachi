# Tomodachi — Arabic Lesson-Copy Review (self-contained)
...
- **AR title:** صف «さ» — أصوات السين
- **EN intro:** The s row: sa, shi, su, se, so. Watch the second one — it is shi, not si. Small exceptions like this are worth noticing early.
- **AR intro:** صف السين: sa، shi، su، se، so. انتبه إلى الثاني — يُنطق shi لا si؛ ومن المفيد ملاحظة هذه الاستثناءات الصغيرة مبكرًا.

### 4. `hiragana:04`
- **EN title:** The た Row — T Sounds
- **AR title:** صف «た» — أصوات التاء
- **EN intro:** The t row has two surprises: chi (not ti) and tsu (not tu). Say them aloud a few times — the sounds matter more than the spelling.
- **AR intro:** في صف التاء مفاجأتان: chi (لا ti) وtsu (لا tu). انطِقهما بصوتٍ عالٍ عدة مرات — فالصوت أهم من كتابته بالحروف اللاتينية.

### 5. `hiragana:05`
- **EN title:** The な Row — N Sounds
- **AR title:** صف «な» — أصوات النون
- **EN intro:** The n row: na, ni, nu, ne, no. These are soft, rounded shapes — take a moment to notice how な and ぬ resemble each other.
- **AR intro:** صف النون: na، ni، nu، ne، no. أشكالها ناعمة ومستديرة — تأمّل كيف يتشابه «な» و«ぬ».
...
- **AR title:** صف «ま» — أصوات الميم
- **EN intro:** The m row: ma, mi, mu, me, mo. You are past the halfway mark of the basic kana now — the pattern should be feeling natural.
- **AR intro:** صف الميم: ma، mi، mu، me، mo. لقد تجاوزت منتصف حروف الكانا الأساسية — ولا بد أن النمط صار مألوفًا لديك.

### 8. `hiragana:08`
- **EN title:** The や Row — Y Sounds
- **AR title:** صف «や» — أصوات الياء
- **EN intro:** A short row: ya, yu, yo — only three. Japanese has no yi or ye sound, so this row skips them. These three will return later to form new sounds.
- **AR intro:** صف قصير: ya، yu، yo — ثلاثة فقط. لا يوجد في اليابانية صوت yi أو ye، وستعود هذه الثلاثة لاحقًا لتكوين أصوات جديدة.

### 9. `hiragana:09`
- **EN title:** The ら Row — R Sounds
- **AR title:** صف «ら» — أصوات الراء
- **EN intro:** The r row: ra, ri, ru, re, ro. The Japanese r is light — a quick tap of the tongue, somewhere between an r and an l. Keep it gentle.
- **AR intro:** صف الراء: ra، ri، ru، re، ro. الراء اليابانية خفيفة — نقرة سريعة باللسان بين الراء واللام. أبقِها خفيفة ولا تُفخِّمها.
...
- **AR title:** اليُوؤُن ٢ — «にゃ» و«ひゃ» و«みゃ» و«りゃ»
- **EN intro:** The same blending rule across four more rows: n, h, m, and r. The pattern is completely regular now — read each as a single, smooth sound.
- **AR intro:** قاعدة الدمج نفسها على أربعة صفوفٍ أخرى: n وh وm وr. صار النمط منتظمًا تمامًا — اقرأ كلًّا منها بوصفه صوتًا واحدًا سلسًا.
...
- **AR title:** الكاتاكانا — صف «カ» (أصوات الكاف)
- **EN intro:** ka, ki, ku, ke, ko. The same a-i-u-e-o order you already mastered in hiragana carries over exactly — only the shapes are new.
- **AR intro:** ka، ki، ku، ke، ko. الترتيب نفسه a، i، u، e، o الذي أتقنته في الهيراغانا ينتقل هنا تمامًا — الأشكال وحدها هي الجديدة.
...
- **AR title:** الكاتاكانا — صف «ハ» (أصوات الهاء)
- **EN intro:** ha, hi, fu, he, ho. ヘ (he) is nearly identical to its hiragana へ — a rare case where the two scripts almost match.
- **AR intro:** ha، hi، fu، he، ho. حرف «ヘ» (he) يكاد يطابق نظيره في الهيراغانا «へ» — وهي حالة نادرة يتشابه فيها النظامان تقريبًا.
...
- **AR title:** الكاتاكانا — صف «ヤ» (أصوات الياء)
- **EN intro:** ya, yu, yo — three again, just like hiragana. These small forms will later combine to spell foreign sounds like ニュ (nyu) in words such as ニュース (news).
- **AR intro:** ya، yu، yo — ثلاثة مجددًا، تمامًا كالهيراغانا. وستتحد هذه الأشكال الصغيرة لاحقًا لكتابة أصواتٍ أجنبية مثل «ニュ» (nyu) في كلماتٍ كـ«ニュース» (أخبار).

### 25. `katakana:09`
- **EN title:** Katakana ラ Row — R Sounds
- **AR title:** الكاتاكانا — صف «ラ» (أصوات الراء)
- **EN intro:** ra, ri, ru, re, ro. This row is everywhere in loanwords — レストラン (restaurant), テレビ (television). The light Japanese r you learned still applies.
- **AR intro:** ra، ri، ru، re، ro. هذا الصف حاضرٌ بكثرة في الكلمات الدخيلة — «レストラン» (مطعم)، «テレビ» (تلفاز). وتبقى الراء اليابانية الخفيفة التي تعلّمتها سارية.
...
- **AR title:** كاتاكانا اليُوؤُن ٢ — «ニャ» و«ヒャ» و«ミャ» و«リャ»
- **EN intro:** Four more blended rows: n, h, m, r. ニュ (nyu) and リュ (ryu) show up often in transliterated names and news vocabulary.
- **AR intro:** أربعة صفوفٍ ممزوجة أخرى: n وh وm وr. ويكثر ظهور «ニュ» (nyu) و«リュ» (ryu) في الأسماء المنقولة ومفردات الأخبار.
...
- **EN title:** Greetings
- **AR title:** التحيات
- **EN intro:** Your first real words. These everyday greetings and polite phrases are what you will say — and hear — in the very first minute of any conversation.
- **AR intro:** أولى كلماتك الحقيقية. هذه التحيات والعبارات المهذّبة اليومية هي ما ستقوله — وتسمعه — في الدقيقة الأولى من أي محادثة.

### 34. `vocab:greetings_more`
- **EN title:** More Greetings
- **AR title:** مزيد من التحيات
- **EN intro:** A few more social phrases, including the ones said before and after meals and when coming and going from home — small courtesies that matter a great deal in Japan.
- **AR intro:** عباراتٌ اجتماعية إضافية، منها ما يُقال قبل الطعام وبعده وعند الدخول إلى البيت والخروج منه — مجاملاتٌ صغيرة لها وزنٌ كبير في اليابان.
...
- **AR title:** الصفات اليومية
- **EN intro:** Describe things: big and small, new and old, hot and cold, good and bad. With these you can finally say more than just an object's name.
- **AR intro:** صِف الأشياء: كبير وصغير، جديد وقديم، حارّ وبارد، جيّد وسيّئ. بهذه الصفات تستطيع أخيرًا أن تقول أكثر من مجرّد اسم الشيء.
...
### 40. `vocab:time`
- **EN title:** Time & Days
- **AR title:** الوقت والأيام
- **EN intro:** Today, tomorrow, yesterday, and the days of the week. Time words let you say when something happens — the backbone of planning and daily talk.
- **AR intro:** اليوم، غدًا، أمس، وأيام الأسبوع. كلمات الوقت تتيح لك قول متى يحدث الشيء — وهي العمود الفقري للتخطيط والحديث اليومي.
...
- **AR title:** أفعال البيت والروتين
- **EN intro:** The verbs of daily life at home: to study, to clean, to wash, to rest. Enough to describe your day from start to finish.
- **AR intro:** أفعال الحياة اليومية في البيت: يدرس، وينظّف، ويغسل، ويستريح. أفعالٌ تكفيك لتصف بها يومك من أوله إلى آخره.

### 49. `vocab:objects`
- **EN title:** Everyday Objects
- **AR title:** أشياء يومية
- **EN intro:** The things around you at home and at work: books, pens, phones, tables. Concrete nouns that fill out your descriptions of any room.
- **AR intro:** الأشياء من حولك في البيت والعمل: الكتب، الأقلام، الهواتف، الطاولات. أسماءٌ محسوسة تُثري وصفك لأي غرفة.
